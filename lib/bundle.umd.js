(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global = global || self),
        factory(
          ((global.apollo = global.apollo || {}),
          (global.apollo.cache = global.apollo.cache || {}),
          (global.apollo.cache.inmemory = {})),
          global.apolloCache.core,
          global.apollo.utilities,
          global.optimism
        ));
})(this, function(exports, apolloCache, apolloUtilities, optimism) {
  'use strict';
  ...
  var StoreReader = (function() {
    function StoreReader(cacheKeyRoot) {
      ...
      this.executeStoreQuery = optimism.wrap(
        function(options) {
      ...
      this.executeSelectionSet = optimism.wrap(
        function(options) {
    ...
    StoreReader.prototype.readQueryFromStore = function(options) {
      ...
      return this.diffQueryAgainstStore(__assign({}, options, optsPatch))
        .result;
    };
    StoreReader.prototype.diffQueryAgainstStore = function(_a) {
      ...
      variables = apolloUtilities.assign(
        {},
        apolloUtilities.getDefaultValues(queryDefinition),
        variables
      );
      var context = {
        store: store,
      ...
      selectionSet.selections.forEach(function(selection) {
        ...
        if (apolloUtilities.isField(selection)) {
          var fieldResult = handleMissing(
            _this.executeField(object, typename, selection, execContext)
          );
          if (typeof fieldResult !== 'undefined') {
            objectsToMerge.push(
              ((_a = {}),
              (_a[
                apolloUtilities.resultKeyNameFromField(selection)
              ] = fieldResult),
              _a)
            );
          }
          ...
          var match = execContext.fragmentMatcher(
            rootValue,
            typeCondition,
            contextValue
          );
    ...
    StoreReader.prototype.executeField = function(
      ...
      var readStoreResult = readStoreResolver(
        object,
        typename,
        fieldName,
        args,
    ...
    StoreReader.prototype.executeSubSelectedArray = function(
      field,
      result,
      execContext
    ) {
      ...
      result = result.map(function(item) {
        ...
        if (Array.isArray(item)) {
          return handleMissing(
            _this.executeSubSelectedArray(field, item, execContext)
          );
        }
        if (field.selectionSet) {
          return handleMissing(
  ...
  function readStoreResolver(object, typename, fieldName, args, context, _a) {
    ...
    if (args || directives) {
      storeKeyName = apolloUtilities.getStoreKeyName(
        storeKeyName,
        args,
        directives
      );
  ...
  var StoreWriter = (function() {
    ...
    StoreWriter.prototype.writeResultToStore = function(_a) {
      var dataId = _a.dataId,
        ...
        dataIdFromObject = _a.dataIdFromObject,
        fragmentMatcherFunction = _a.fragmentMatcherFunction;
      var operationDefinition = apolloUtilities.getOperationDefinition(
        document
      );
      try {
        return this.writeSelectionSetToStore({
          ...
          context: {
            ...
            variables: apolloUtilities.assign(
              {},
              apolloUtilities.getDefaultValues(operationDefinition),
              variables
            ),
            dataIdFromObject: dataIdFromObject,
            fragmentMap: apolloUtilities.createFragmentMap(
              apolloUtilities.getFragmentDefinitions(document)
            ),
            fragmentMatcherFunction: fragmentMatcherFunction
          }
        });
    ...
    StoreWriter.prototype.writeSelectionSetToStore = function(_a) {
      ...
      selectionSet.selections.forEach(function(selection) {
        ...
        if (apolloUtilities.isField(selection)) {
          var resultFieldKey = apolloUtilities.resultKeyNameFromField(
            selection
          );
          ...
          if (context.fragmentMatcherFunction && fragment.typeCondition) {
            var idValue = apolloUtilities.toIdValue({
              id: 'self',
              typename: undefined
            });
            var fakeContext = {
            ...
            var match = context.fragmentMatcherFunction(
              idValue,
    ...
    StoreWriter.prototype.writeFieldToStore = function(_a) {
      ...
      var storeValue;
      var storeObject;
      var storeFieldName = apolloUtilities.storeKeyNameFromField(
        field,
        variables
      );
      if (!field.selectionSet || value === null) {
        ...
        storeValue = apolloUtilities.toIdValue(
          { id: valueDataId, typename: typename },
          generated
        );
      ...
      if (
        !storeObject ||
        !apolloUtilities.isEqual(storeValue, storeObject[storeFieldName])
      ) {
        store.set(
          dataId,
          __assign(
  ...
  function mergeWithGenerated(generatedKey, realKey, cache) {
    ...
    Object.keys(generated).forEach(function(key) {
      ...
      if (
        apolloUtilities.isIdValue(value) &&
  ...
  var InMemoryCache = (function(_super) {
    ...
    function InMemoryCache(config) {
      ...
      _this.maybeBroadcastWatch = optimism.wrap(
        function(c) {
